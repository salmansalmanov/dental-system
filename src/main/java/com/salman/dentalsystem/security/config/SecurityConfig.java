    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception { // throws Exception əlavə edildi
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/patients/{id}/appointments").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.GET, "/v1/patients/*/appointments").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.POST, "/v1/patients").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.GET, "/v1/patients").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.GET, "/v1/patients/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.PUT, "/v1/patients/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.PATCH, "/v1/patients/*/activate").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.PATCH, "/v1/patients/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/appointments/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.PUT, "/v1/appointments/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.POST, "/v1/xray/upload").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/xray/appointment/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.GET, "/v1/xray/*").hasAnyRole("DENTIST", "ADMIN", "RECEPTIONIST")
                        .requestMatchers(HttpMethod.DELETE, "/v1/xray/*").hasAnyRole("DENTIST", "ADMIN")
